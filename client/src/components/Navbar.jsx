    ...
    <nav className="sticky top-0 z-50 py-3 backdrop-blur-lg border-b">
      <div className="container px-4 mx-auto relative lg:text-sm">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden lg:flex ml-14 space-x-12 font-mono text-xl">
        ...
        {mobileDrawerOpen && (
          <div className="fixed right-0 z-20 backdrop-blur-lg w-full p-12 flex flex-col justify-center items-center lg:hidden">
            <ul>
              {navItems.map((item, index) => (
